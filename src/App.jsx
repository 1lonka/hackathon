...
// --- DATA FOTOAPARÁTŮ ---
const CAMERAS = [
  { id: 'obscura', name: 'Obscura', year: '1550', devTime: 8000, filter: 'brightness(0.4) blur(3px) sepia(0.2)', view: { transform: 'rotate(180deg) scale(1.1)' }, data: { f: '--', t: '--', iso: '--' }, sound: 'cameraobscura.wav', realTime: "Zajímavost: Obraz se musel ručně překreslovat několik hodin." },
  { id: 'daguerre', name: 'Daguerre', year: '1839', devTime: 7000, filter: 'sepia(1) contrast(1.1) grayscale(0.2) blur(0.5px)', view: { transform: 'rotate(180deg) blur(1.5px) brightness(0.7)' }, data: { f: '--', t: '5m', iso: '0.01' }, sound: 'daguerete.wav', realTime: "Zajímavost: Vyvolání trvalo až 60 minut nad jedovatou rtutí." },
  { id: 'kodak', name: 'Kodak No.1', year: '1888', devTime: 5000, filter: 'grayscale(1) contrast(0.8) sepia(0.3)', view: { transform: 'scale(1.1) brightness(0.8)' }, data: { f: '9.0', t: '1/25', iso: '25' }, sound: 'kodak.wav', realTime: "Zajímavost: Na fotky se čekalo 2 týdny, než přišly poštou z továrny." },
  { id: 'leica', name: 'Leica I', year: '1925', devTime: 3000, filter: 'grayscale(1) contrast(1.5) brightness(1.1)', data: { f: '3.5', t: '1/200', iso: '50' }, sound: 'leica.mp3', realTime: "Zajímavost: Film se musel složitě vyvíjet v temné komoře." },
  { id: 'nikon', name: 'Nikon F', year: '1959', devTime: 1500, filter: 'contrast(1.2) saturate(0.8)', data: { f: '2.8', t: '1/500', iso: '200' }, sound: 'nikon.wav', realTime: "Zajímavost: Fotky byly k vyzvednutí ve sběrně nejdříve druhý den." },
  { id: 'polaroid', name: 'Polaroid', year: '1972', devTime: 4000, filter: 'sepia(0.2) saturate(1.8) hue-rotate(-10deg)', data: { f: '8.0', t: '1/125', iso: '640' }, sound: 'polaroid.wav', realTime: "Zajímavost: Snímek se vybarvoval cca 60 sekund přímo před očima." },
  { id: 'sony', name: 'Sony A7', year: '2013', devTime: 0, filter: 'contrast(1.1) saturate(1.1)', data: { f: '1.8', t: '1/2000', iso: '1600' }, sound: 'sonya7.wav', realTime: "Digitální revoluce: Snímač zpracuje obraz za méně než 0.01 s." },
  { id: 'smartphone', name: 'iPhone', year: '2026', devTime: 0, filter: 'none', data: { f: '1.6', t: '1/4000', iso: '3200' }, sound: 'iphone.wav', realTime: "Současnost: Fotka je vylepšena miliardami operací pomocí AI." }
];
...
export default function App() {
  ...
  return (
    <div style={{ backgroundColor: '#0a0a0a', minHeight: '100vh', width: '100vw', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#fff', fontFamily: 'serif', overflow: 'hidden' }}>
      
      {/* TĚLO FOTOAPARÁTU */}
      <div style={{ width: '850px', height: '550px', backgroundColor: '#1a1a1a', borderRadius: '40px', border: '12px solid #111', display: 'flex', flexDirection: 'column', position: 'relative', boxShadow: '0 50px 100px rgba(0,0,0,0.9)' }}>
      ...
      <h1 style={{ color: '#d4af37', marginTop: '30px', letterSpacing: '12px', textTransform: 'uppercase', fontSize: '4.5rem', fontWeight: 'bold' }}>{activeCam.name}</h1>
      ...
      {showResult && (
        <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(0,0,0,0.98)', zIndex: 100, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '30px', flexWrap: 'wrap', justifyContent: 'center' }}>
            {/* HISTORICKÁ FOTKA (S OPRAVENÝM EFEKTEM VYVÍJENÍ) */}
              ...
              <div style={{ overflow: 'hidden', height: '350px', backgroundColor: '#fff' }}>
                <img 
                  ...
                  style={{ 
                    ...
                    height: '100%', 
                    objectFit: 'cover', 
                    // TADY JE TA OPRAVA: Procento kontrastu stoupá, jas klesá z bílé do normálu
                    filter: isDeveloping 
                      ? `brightness(${2.5 - (progress/100)}) contrast(${progress/100}) ${activeCam.filter}` 
                      : activeCam.filter, 
                    opacity: isDeveloping ? (progress/100) : 1,
                    ...(activeCam.view || { transform: 'none' }) 
                  }} 
                />
              </div>
            ...
            {!isDeveloping && activeCam.id !== 'smartphone' && (
              <div style={{ backgroundColor: '#fff', padding: '15px 15px 50px 15px', boxShadow: '0 20px 40px #000', width: '350px', border: '4px solid #d4af37', animation: 'fadeIn 0.5s ease-out' }}>
                ...
                <p style={{ color: '#000', textAlign: 'center', marginTop: '10px', fontWeight: 'bold' }}>IPHONE 17 PRO (2026)</p>
              </div>
            )}
          </div>
